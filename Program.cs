...
PrintResults(Enumerable.Range(1, 100), [FizzBuzzRule, FizzRule, BuzzRule]); // Viktig med rekkefølgen på regler i listen

var JazzRule = new Rule("Jazz", 9);
var FuzzRule = new Rule("Fuzz", 4);
var JazzFuzzRule = new Rule("Fuzz", 4, 9);
PrintResults(Enumerable.Range(1, 100).Reverse(), [JazzFuzzRule, JazzRule, FuzzRule]);  // Viktig med rekkefølgem på regler i listen